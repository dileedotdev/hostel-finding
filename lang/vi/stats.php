...
return [
    'vote.count.*' => 'Số lượng đánh giá',
    'vote.average.score' => 'Điểm trung bình đánh giá',
    'visit.count.*.guest' => 'Số lượng lượt truy cập của khách',
    'visit.count.*.user' => 'Số lượng lượt truy cập của người dùng',
    'visit.count.ip.distinct' => 'Số lượng IP khác nhau',
